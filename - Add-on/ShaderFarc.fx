//=== Settings: ===//
	...
	// Aniso:
	float2 Intervals = float2(10.0f, 0.0f); // Blur Size (Radius)
	float DepthF = 100;  // Depth
...
{	
  ...
  float Pi = 6.28318530718; // Pi*2
    ...
    float2 Radius = (lerp(Intervals.x, Intervals.y, saturate(tex2D(DS, v1).x/DepthF)))/ViewportSize.xy;
