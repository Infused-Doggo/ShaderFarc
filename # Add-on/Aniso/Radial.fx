...
// Texture Maps :
//==================================================//
#define _Normal "MAP(s)/F_DIVA_MIK500_HAIRFRONT_N.png"
#define _Specular "MAP(s)/F_DIVA_MIK500_HAIRFRONT_S.png"
#define _Env_Map "MAP(s)/F_DIVA_ENVMAP02.dds"
// - - - - - - - - - - - - - - - - - - - -
#define _Translucency "MAP(s)/F_DIVA_MIK500_HAIRFRONT_T.png"
#define _Transparency "MAP(s)/F_DIVA_ALPHA.png"

//====== General: ======//
#define Diffuse float4(1, 1, 1, 1)
#define Ambient float4(1, 1, 1, 1)
#define Specular float4(1, 1, 1, 1)
