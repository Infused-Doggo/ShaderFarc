...
#define Light_Dir "Directional Light" //Choose the bone used to control the IBL
float4x4 Light_Controller : CONTROLOBJECT < string name = Controller; string item = Light_Dir ; >;
static float3 HgShadow_LightDirection = Light_Controller._31_32_33;
